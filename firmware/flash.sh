...
read -p "bring GPIO0 low, reset device, and press enter"
esptool.py --port /dev/ttyUSB1 --baud 460800 write_flash --flash_size=detect --verify -fm dio 0x0 ./microhomie-esp8266-v3.0.2.bin
...
ampy -p /dev/ttyUSB1 put settings.mpy
python -m mpy_cross max9651.py
ampy -p /dev/ttyUSB1 put max9651.mpy
read -p "reset device and press enter"
echo "done!"
